          ...
          <section class="p-5">
            <div class="p-1 rounded-md">
              <form id="image-form" class="flex flex-col form-control">
                <h1
                  class="text-xl sm:text-2xl sm:mt-2 font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-orange-300 to-rose-200 mb-3"
                >
                ...
                <div class="flex flex-col">
                  <input
                    type="text"
                    id="prompt"
                    class="input w-full placeholder-pink-300 mt-4"
                  ...
                  <div class="form-control">
                    <select
                      class="select w-full my-3 bg-gray-600 text-black focus:bg-opacity-30 hover:bg-opacity-50"
                      name="size"
                      id="size"
                    >
                      <option value="small">Lite bilde🤏</option>
                      <option value="medium" selected>Middels bilde👌</option>
                      <option value="large">Stort bilde🤪</option>
                    </select>
                  </div>
                </div>
                <button
                  type="submit"
                  class="btn bg-green-700 text-black hover:bg-green-400"
                >
                  Lag bilde...⌛
                </button>
              </form>
